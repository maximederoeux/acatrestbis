...
class OpeningsControllerTest < ActionController::TestCase
  ...
  test "should create opening" do
    assert_difference('Opening.count') do
      post :create, opening: { close: @opening.close, open: @opening.open, season: @opening.season, weekday: @opening.weekday }
    end
  ...
  test "should update opening" do
    patch :update, id: @opening, opening: { close: @opening.close, open: @opening.open, season: @opening.season, weekday: @opening.weekday }
    assert_redirected_to opening_path(assigns(:opening))
  end
